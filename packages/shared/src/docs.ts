...
export const DOC_RULES: DocParagraphSection[] = [
    ...
    },
    {
        title: '无人机',
        paragraphs: [
            '无人机是玩家通过编程控制的 **主要单位**。场上同时可存在 > 1 个无人机。',
    ...
    },
    {
        ...
        paragraphs: [
            ...
            '一种作物在生长中，需要浇水的次数是**固定**的，且均匀地分布在作物生长的整个阶段。',
            '当前版本存在如下特殊机制',
    ...
    },
    {
        ...
        paragraphs: [
            ...
            '- 土地: 基础地块，能种植绝大多数作物',
            '- 沙地: 营养较少的地块, 部分作物无法种植; 在上面种植的作物, 生长周期为正常的 1.5 倍',
            '- 水池: 含水地块，无人机可在上方蓄水。部分水生作物可以在上面种植',
        ],
    },
    {
        title: '能量机制',
        paragraphs: [
            ...
            '例如, HarvestRow 操作消耗能量, 允许无人机在同一回合收割 **横向 3 格** 上的作物。',
